...
A simple, clean and easy to use website for the Rinzai Zen Center of the Montreal-Plateau area. 
Made with classic HTML5/CSS3/JS 
...
A Progressive Web App generated by Ionic with the Angular Framework. It uses 2 Native Plugins as services. One to Geolocate and another to show you on the Map ( Google Maps for Angular ). The App records and saves your favorites places in a MySQL database or in local storage data depending on availability.
